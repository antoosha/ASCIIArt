...
class InvertGrayscaleImageFilterTest extends FunSuite {

  test("Apply invert filter. Height was not changed") {
    //to filter image
    ...
    ///result image
    val resultGrayscalePixel: GrayscalePixel = new GrayscalePixel(155)
    ...
    val filter: InvertGrayscaleImageFilter = new InvertGrayscaleImageFilter()
  ...
  test("Apply invert filter. Width was not changed") {
    //to filter image
    val grayscalePixel: GrayscalePixel = new GrayscalePixel(100)
    var pixelRow: Seq[GrayscalePixel] = Seq.empty
    pixelRow = pixelRow.appended(grayscalePixel)
  ...
  test("Apply invert filter. Value was inverted.") {
    //to filter image
    val grayscalePixel: GrayscalePixel = new GrayscalePixel(100)
    var pixelRow: Seq[GrayscalePixel] = Seq.empty
    pixelRow = pixelRow.appended(grayscalePixel)
  ...
  test("Apply invert filter. Value was inverted. Started value is 255") {
    //to filter image
    val grayscalePixel: GrayscalePixel = new GrayscalePixel(255)
    var pixelRow: Seq[GrayscalePixel] = Seq.empty
    pixelRow = pixelRow.appended(grayscalePixel)
    var pixelGrid: Seq[Seq[GrayscalePixel]] = Seq.empty
    pixelGrid = pixelGrid.appended(pixelRow)
  ...
  test("Apply invert filter. Value was inverted. Started value is 0") {
    //to filter image
    val grayscalePixel: GrayscalePixel = new GrayscalePixel(0)
    var pixelRow: Seq[GrayscalePixel] = Seq.empty
    pixelRow = pixelRow.appended(grayscalePixel)
    var pixelGrid: Seq[Seq[GrayscalePixel]] = Seq.empty
    pixelGrid = pixelGrid.appended(pixelRow)
